        ...
        <div className="profileInfo">
            ...
            <div className="profile__card card">
                <picture className="card__photo-wrapper">
                    ...
                    <img src={props.profile.photos.large} className="card__photo-img" alt="profilePhoto" /> :
                ...
                <div className="card__text">
                    ...
                    <div className="card__job_search">
                        <b>Ищу работу: </b> {(props.profile.lookingForAJob) ? <img className="card__job_search_img" src={yes} alt="да"/> : <img className="card__job_search_img" src={no} alt="нет"/>  }
                     </div>
                    ...
                    <div className="card__socials socials">
                        {(props.profile.contacts.facebook) &&
                            <a href={props.profile.contacts.facebook} className="socials__link">
                                <img src={facebook} alt="facebook" className="socials__img" />
                            </a>}
                        {(props.profile.contacts.website) && 
                            <a href={props.profile.contacts.website} className="socials__link">
                        ...
                        {(props.profile.contacts.twitter) && 
                            <a href={props.profile.contacts.twitter} className="socials__link">
                            <img src={twitter} alt="twitter" className="socials__img" />
                        </a>}
                        {(props.profile.contacts.instagram) && 
                        <a href={props.profile.contacts.instagram} className="socials__link">
                            <img src={instagram} alt="instagram" className="socials__img" />
                        </a>}
                        {(props.profile.contacts.youtube) &&
                            <a href={props.profile.contacts.youtube} className="socials__link">
